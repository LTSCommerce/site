...
| Priority | Handler | Behaviour | Description |
|----------|---------|----------|-------------|
| 40 | ArticleSnippetEnforcerHandler | TERMINAL | Enforce the snippet-injection system for articles |
| 55 | TsQaCiHandler | NON-TERMINAL | Advisory handler surfacing ts-qa-ci pipeline status to Claude Code sessions |
